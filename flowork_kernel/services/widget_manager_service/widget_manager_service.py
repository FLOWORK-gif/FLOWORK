...
# File NAME : C:\FLOWORK\widgets\widget_manager_service\widget_manager_service.py
...
class WidgetManagerService(BaseService):
    ...
    [MODIFICATION] Implements hybrid loading: prioritizes locked native modules (.aola_flowork)
    ...
    def _process_single_widget(self, widget_dir, widget_id, paused_ids, manifest_override=None):
        ...
        try:
            ...
            native_file_path = os.path.join(widget_dir, f"{module_filename}.aola_flowork")
            ...
            is_native_module = path_to_load.endswith(".aola_flowork") # (ADDED) Flag
            ...
            if is_native_module:
                ...
                module_full_name = f"flowork_native_widget.{safe_widget_id}.{module_filename}"
    ...
    # [MODIFIED] Standardized dependency installer.
