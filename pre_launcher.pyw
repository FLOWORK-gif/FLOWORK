...
def run_background_processes(window_instance):
    try:
        ...
        if is_first_run:
            ...
            # (DIUBAH) Gunakan pythonw.exe juga untuk bootstrap agar 100% silent
            python_exe = os.path.join(PROJECT_ROOT, "python", "pythonw.exe")
        ...
        # (FIXED) Point to the .pyw file to ensure the next stage also runs without a console flash.
        launcher_script_path = os.path.join(PROJECT_ROOT, "launcher.pyw")
