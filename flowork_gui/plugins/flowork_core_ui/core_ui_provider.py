from api_contract import BaseModule, BaseUIProvider # PENAMBAHAN OTOMIS
...
# COMMENT: Temporarily disabled scanner UI page to focus on other errors.
...
class CoreUIProvider(BaseModule, BaseUIProvider):
    ...
    def get_menu_items(self):
        ...
        all_items = [
            ...
            # },
            # COMMENT: Temporarily disabled scanner UI menu to focus on other errors.
            {
                "parent": self.loc.get('menu_help', fallback="Help"),
                "add_separator": True,
        ...
        for item in all_items:
            if item.get('label') == self.loc.get('diagnostics_tab_title', fallback="System Diagnostics"):
                # COMMENT: Temporarily disabled scanner UI menu to focus on other errors.
                continue
