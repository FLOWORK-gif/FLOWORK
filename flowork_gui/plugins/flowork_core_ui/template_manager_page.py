    ...
    def __init__(self, parent_notebook, api_client, loc_service, **kwargs):
        ...
        class MockKernel:
            def __init__(self, api_client_instance, loc_instance):
                ...
                # COMMENT: This path is a temporary fix for the decoupled GUI.
                # The correct long-term solution is to fetch themes via an API endpoint.
                # This path navigates from .../flowork_gui/plugins/flowork_core_ui/ up to C:/FLOWORK/ and then down to /themes.
