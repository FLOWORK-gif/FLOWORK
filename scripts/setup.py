...
def run_command(command, message):
    ...
    try:
        process = subprocess.Popen(
            ...
            encoding='utf-8',
            errors='replace',
            # (THE ULTIMATE FIX) Using shell=False prevents cmd.exe from flashing.
            # This is the true root cause of the console window.
            shell=False,
...
def main():
    ...
    # (MODIFIED) Commands must be lists of strings when shell=False
