...
class ManualApprovalModule(BaseModule, IExecutable, IConfigurableUI, IDataPreviewer):
    ...
    def get_data_preview(self, config: dict):
        ...
        """
        return [{'status': 'preview_not_available', 'reason': 'Pauses execution for live user approval.'}]
