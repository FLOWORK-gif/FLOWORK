 ...
 */
extern PyObject *modulecode_processor(PyThreadState *tstate, PyObject *, struct Nuitka_MetaPathBasedLoaderEntry const *);

static struct Nuitka_MetaPathBasedLoaderEntry meta_path_loader_entries[] = {
    {"processor", modulecode_processor, 0, 0, NUITKA_TRANSLATED_FLAG
