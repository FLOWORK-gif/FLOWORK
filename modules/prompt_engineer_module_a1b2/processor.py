...
class PromptEngineerModule(BaseModule, IExecutable, IConfigurableUI, IDataPreviewer):
    """
    (REMASTERED V3) This module now directly fetches and uses a prompt template
    from the Prompt Manager, making it a key component in the Flowork architecture.
    """
    TIER = "free"
    ...
    def create_properties_ui(self, parent_frame, get_current_config, available_vars):
        ...
        class PromptIdVar:
            """Proxy untuk menerjemahkan nama yang dipilih kembali ke ID saat disimpan."""
