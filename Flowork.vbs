...
If fso.FileExists(lockFilePath) Then
    ...
    ' NOTE: The teetah.art file exists, so we proceed with the standard silent launch.
...
Else
    ...
    ' --- [MODIFIED] Logic for creating lock file has been moved to DEBUG.bat ---
    ' NOTE: The creation of 'teetah.art' is now handled by DEBUG.bat itself
    ' to ensure it's only created after a successful setup process.
    '
    ' Dim lockFile
