...
# (DIUBAH) Pengiriman sinyal ditunda sedikit untuk memastikan UI siap
#######################################################################
...
def run_gui_mode(kernel_instance):
    ...
    # (DIUBAH) Pengiriman sinyal ditunda 100 milidetik setelah mainloop dimulai.
    # Ini memastikan jendela aplikasi sudah benar-benar dalam proses render sebelum sinyal dikirim.
    # signal_preloader_app_is_ready() # (DIKOMENTARI) Cara lama yang terlalu cepat
    root.after(100, signal_preloader_app_is_ready) # (DITAMBAHKAN) Cara baru yang lebih aman
