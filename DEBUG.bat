...
REM --- [ADDED] Create lock file after successful run ---
REM NOTE: Creating the 'teetah.art' lock file now to signify that the
REM first-time setup and execution was successful.
echo [SUCCESS] First-time run process completed.
echo [INFO] Creating lock file to enable normal startup next time...
echo. > teetah.art
