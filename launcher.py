...
def main():
    ...
    # (MODIFIED) Wrapped the entire main logic in a try...finally block
    try:
        ...
        try:
            ...
            creationflags = 0
            if platform.system() == "Windows":
                # (MODIFIED) Hide the console window of the main app as well
        ...
        # (ADDED) This block will always run, ensuring the preloader popup is closed
        cleanup_preloader()
