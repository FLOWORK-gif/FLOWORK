...
# (FINAL) Production-ready version, silent execution.
#######################################################################
import sys
import os
import zipfile
...
def extract_archive(zip_name, target_dir, project_root):
    ...
    if os.path.exists(target_path):
        # This message will only be seen if run from a manual console.
...
def main():
    ...
    try:
        ...
        # --- REVERTED TO PRODUCTION LOGIC (1/2) ---
        # NOTE: This logic prioritizes the silent 'pythonw.exe' for a clean user experience.
        ...
        try:
            ...
            # --- REVERTED TO PRODUCTION LOGIC (2/2) ---
            # NOTE: Re-enabling the CREATE_NO_WINDOW flag to hide the console.
            creationflags = 0
            if platform.system() == "Windows":
